...
- **Computer science cơ bản**: [Hướng dẫn phỏng vấn kiến thức nền tảng](./cs-basics/): hệ thống hóa computer network, operating system, data structure và algorithm — nền tảng tầng dưới cho phỏng vấn backend, phù hợp để bù đắp lỗ hổng kiến thức cơ bản.
