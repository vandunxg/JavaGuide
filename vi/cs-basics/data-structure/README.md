...
2. Truy vấn, chèn và xoá có complexity trung bình là `O(1)`, nhưng có thể suy biến khi collision nghiêm trọng.
...
5. [Giải thích chi tiết graph](./graph.md): hiểu cách lưu trữ graph, DFS, BFS, topological sort và các khái niệm cơ bản về shortest path.
...
7. [Tổng hợp câu hỏi phỏng vấn skip list](./skip-list.md), [Giải thích chi tiết red-black tree](./red-black-tree.md), [Giải thích chi tiết Bloom filter](./bloom-filter.md), [Tổng hợp câu hỏi phỏng vấn LRU cache](./lru-cache.md): ôn lại trong các trường hợp sử dụng với Java Collections, Redis, cache và database.
...
| [Giải thích chi tiết graph](./graph.md)                                 | adjacency list, adjacency matrix, DFS, BFS | quan hệ phụ thuộc, routing, quan hệ gợi ý |
