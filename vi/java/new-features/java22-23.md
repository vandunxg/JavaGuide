---
title: "Tổng quan các tính năng mới của Java 22 & 23"
description: "Tổng quan các JEP quan trọng và những cải tiến về ngôn ngữ/nền tảng của JDK 22/23, liên tục theo dõi các thay đổi liên quan đến performance và concurrency."
category: Java
tag:
  - Java New Features
head:
...
- [JEP 477: Unnamed Classes and Instance Main Methods (Third Preview) (Unnamed Classes và instance main method, preview lần thứ ba)](https://openjdk.org/jeps/477)
...
Foreign Function and Memory API được incubate lần đầu trong Java 17 theo [JEP 412](https://openjdk.java.net/jeps/412). Java 18 là lần incubate thứ hai theo [JEP 419](https://openjdk.org/jeps/419). Trong Java 19, đây là preview lần đầu theo [JEP 424](https://openjdk.org/jeps/424). Trong JDK 20, đây là preview lần thứ hai theo [JEP 434](https://openjdk.org/jeps/434). Trong JDK 21, đây là preview lần thứ ba theo [JEP 442](https://openjdk.org/jeps/442).
...
Bạn có thể xem giới thiệu chi tiết về tính năng mới này trong bài viết [Tổng quan các tính năng mới trong Java 21 (quan trọng)](./java21.md).
...
[JEP 458: Launch Multi-File Source-Code Programs](https://openjdk.org/jeps/458) là phần mở rộng của chức năng JEP 330, cho phép chạy trực tiếp program gồm nhiều Java source file mà không cần bước compile tường minh.
