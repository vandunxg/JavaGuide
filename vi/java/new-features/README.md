...
Nếu thời gian khá hạn hẹp, bạn có thể xem trước [Tổng hợp câu hỏi phỏng vấn Java New Features](https://interview.javaguide.cn/java/java-new-features.html) bản cấp tốc cho phỏng vấn, sau đó quay lại chuyên đề này để xem giải thích đầy đủ của từng phiên bản.

## Dành cho ai

- Nhà phát triển Java muốn tìm hiểu có hệ thống những thay đổi từ Java 8 trở đi.
- Người chuẩn bị các câu hỏi phỏng vấn về Java New Features, khác biệt giữa các phiên bản LTS, virtual thread, Record, pattern matching và các chủ đề khác.
- Kỹ sư phụ trách nâng cấp JDK, cần đánh giá những tính năng nào sẽ ảnh hưởng đến code của dự án và biểu hiện khi chạy.
...
- Những khả năng ổn định đáng ưu tiên nắm vững hơn trong các phiên bản LTS như Java 11, 17, 21.
...
2. [Tổng quan Java 9 New Features](./java9.md), [Tổng quan Java 10 New Features](./java10.md): tìm hiểu module system và những thay đổi nền tảng như type inference cho local variable.
...
- [Tổng quan Java 10 New Features](./java10.md): tìm hiểu type inference cho local variable và các cải tiến runtime.
...
- [Tổng quan Java 16 New Features](./java16.md): tìm hiểu Record chính thức trở thành tính năng chính thức, cùng những thay đổi như Pattern Matching for instanceof.
- [Tổng quan Java 18 New Features](./java18.md), [Tổng quan Java 19 New Features](./java19.md), [Tổng quan Java 20 New Features](./java20.md): theo dõi những tiến triển như UTF-8 default charset, virtual thread preview và structured concurrency.
- [Tổng quan Java 22 & 23 New Features](./java22-23.md), [Tổng quan Java 24 New Features](./java24.md), [Tổng quan Java 25 New Features](./java25.md), [Tổng quan Java 26 New Features](./java26.md): tìm hiểu các preview, incubator và formal feature trong những phiên bản mới hơn.
